            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-outline-success" @click="validarDatos()">Actualizar</button>
    ...
    validarDatos() {
      if (this.name !== '' && this.country !== '' && this.length !== '') {
        ...
        this.$notify({
          group: 'foo',
          title: 'Río ' + this.name,
          text: 'ha sido actualizado en el sistema',
        });
        this.gotoInicial();
      } else {
        this.visible = "";
